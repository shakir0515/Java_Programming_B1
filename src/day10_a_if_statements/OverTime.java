...
//public class OverTime
   ...
   /* public static void main(String[] args) {
        ...
        double workedHours = 50;
        double netPay;
        double extraHours = workedHours-40;
        netPay = netPay + extraHours * (hourlyRate * 1.5);
        if(workedHours>40) {
            System.out.println("You worked " + workedHours + " hours at the rate of " + hourlyRate + " but with " + extraHours + " extra hours over time. So you get in total pay off $" + netPay);
        }else {
